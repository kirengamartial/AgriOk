        ...
        <div className="bg-white rounded-lg p-6 shadow-xs">
          <div className="flex items-center gap-3">
            <div className="text-gray-800">
              <div className="text-xl font-bold">40.2°C</div>
            ...
            <div className="space-y-6">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-gray-500 text-xs mt-1">Running out of water</p>
                </div>
                <span className="text-gray-500 text-xs">24 APR</span>
              </div>
              <div className="flex justify-between items-start">
                <div>
                  <h3 className="font-semibold text-gray-800">DISEASE</h3>
                  <p className="text-gray-500 text-xs mt-1">Beginning of infestation of diseases</p>
                </div>
                <span className="text-gray-500 text-xs">24 APR</span>
              </div>
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-gray-500 text-xs mt-1">Beginning of life growth</p>
                </div>
                <span className="text-gray-500 text-xs">24 APR</span>
              </div>
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-gray-500 text-xs mt-1">No weeds</p>
                </div>
                <span className="text-gray-500 text-xs">24 APR</span>
              </div>
            </div>
